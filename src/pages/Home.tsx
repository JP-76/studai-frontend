                ...
                <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                        ...
                        <div className="grid md:grid-cols-2 gap-4 mb-8">
                            {/* Tema Livre */}
                            <div
                                className={`card cursor-pointer transition-all hover:shadow-lg ${selectedOption === "tema"
                            ...
                            {/* URL YouTube */}
                            <div
                                className={`card cursor-pointer transition-all hover:shadow-lg ${selectedOption === "url"
                                        ? "bg-primary/10 border-2 border-primary"
                                        : "bg-base-200 hover:bg-base-300"
                                    }`}
